...
namespace EventCatalogAPI.Data
{
    public class EventSeed
    {
        ...
        private static IEnumerable<EventItem> GetEventItems()
        {
            ...
            {
             new EventItem{EventCatagoryId = 7, EventLocationId =7, Description = "All-You-Can-Eat Ice Cream Festival", Name = "IceCream Feast", Price = 50, PictureURL = "http://externalcatalogbaseurltobereplaced/api/Pic/1", EventDate = new System.DateTime(2022, 08 , 27), Address = "Onyx, 156th Ave", Organizer = "RemondEvents"},
             ...
             new EventItem{EventCatagoryId = 6, EventLocationId =7, Description = "Joy Of Breathing Free Class", Name = "Pranayama ", Price = 0, PictureURL = "http://externalcatalogbaseurltobereplaced/api/Pic/5", EventDate = new System.DateTime(2022, 08 , 31), Address = "MaryMoor Park", Organizer = "RemondEvents"},

             new EventItem{EventCatagoryId = 6, EventLocationId =5, Description = "Meditate, meet and get motivated.", Name = "Guided Meditation", Price = 25, PictureURL = "http://externalcatalogbaseurltobereplaced/api/Pic/6", EventDate = new System.DateTime(2022, 09, 01), Address = "Issaquah Heights", Organizer = "IssaquahEvents"},

             new EventItem{EventCatagoryId = 5, EventLocationId =6, Description = "Exploring the world of Torch and Twang - featuring great singers and players", Name = "Wintergrass", Price = 120, PictureURL = "http://externalcatalogbaseurltobereplaced/api/Pic/7", EventDate = new System.DateTime(2022, 09, 02), Address = "Hyatt Regency", Organizer = "BellevueEvents"},

             new EventItem{EventCatagoryId = 5, EventLocationId =3, Description = "Massive Fridays at Trinity -by Trinity Nightclub", Name = "Massive Fridays", Price = 150, PictureURL = "http://externalcatalogbaseurltobereplaced/api/Pic/8", EventDate = new System.DateTime(2022, 09, 10), Address = "Trinity Occidental Avenue South", Organizer = "SeattleEvents"},

             new EventItem{EventCatagoryId = 5, EventLocationId =4, Description = "LIVE 80's New Wave at 10th annual Summerfest", Name = "Nite Wave Concert", Price = 70, PictureURL = "http://externalcatalogbaseurltobereplaced/api/Pic/9",EventDate = new System.DateTime(2022, 09, 11), Address = "Marina Park 25 Lakeshore Plaza", Organizer = "RentonEvents"},


             new EventItem{EventCatagoryId = 1, EventLocationId =7, Description = "Eric Solberg IS BACK! Not even a van can stop this man!",
             ...
             new EventItem{EventCatagoryId = 1, EventLocationId =1, Description = "Visit the world's first NFT museum!",
             ...
             new EventItem{EventCatagoryId = 1, EventLocationId =5, Description = "Lola by Can Can , Seattle's World-Class Cabaret",
